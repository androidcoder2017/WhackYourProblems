...
public class Level8 extends AppCompatActivity implements View.OnClickListener {
         ...
         runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (left == 0) {
                    ...
                    saveData("8", score);
                    AlertDialog.Builder builder = new AlertDialog.Builder(Level8.this);
                    builder.setTitle("Level 8 Complete!");
                    builder.setMessage("You have won! You have unlock level 9!");
                    builder.setPositiveButton("Unlock", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(Level8.this, LevelPage.class);
    ...
    public void onClick(View v) {
        if (isPreseed) {
            btnVolume.setBackgroundResource(R.drawable.mutevolume);
            Intent intent = new Intent(Level8.this, MusicService.class);
            stopService(intent);
